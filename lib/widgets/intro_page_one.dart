...
class IntroPageOne extends StatelessWidget {
  ...
  const IntroPageOne({Key? key, required this.size, required this.onBtnClick})
      : super(key: key);
  final Size size;
                  ...
                  child: Column(
                    children: [
                      ...
                      const IntroListTile(
                          ...
                          iconPath: 'assets/images/ic_intro_train.png'),
                      SizedBox(height: size.height * 0.02,),
                      IntroListTile(
                          title: 'Status',
                          subtitle: dummyString,
                          iconPath: 'assets/images/ic_intro_status.png'),
                      SizedBox(height: size.height * 0.02,),
                      IntroListTile(title: 'Apply',
                          subtitle: dummyString,
                          iconPath: 'assets/images/ic_intro_apply.png'),
                      SizedBox(height: size.height * 0.02,),
                      IntroListTile(title: 'Trust',
                          subtitle: dummyString,
                          iconPath: 'assets/images/ic_intro_trust.png'),
                      SizedBox(height: size.height * 0.02,),
                      SizedBox(
